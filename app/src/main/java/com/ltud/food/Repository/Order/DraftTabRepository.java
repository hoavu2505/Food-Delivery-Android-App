...
public class DraftTabRepository {

    private static DraftTabRepository repository;
    ...
    public static DraftTabRepository getInstance()
    {
        if(repository == null)
        {
            repository = new DraftTabRepository();
        }
        return repository;
    }

    public MutableLiveData<List<Order>> getDraftOrder()
    {
    ...
    public void removeDraftOrder(String orderID)
    {
